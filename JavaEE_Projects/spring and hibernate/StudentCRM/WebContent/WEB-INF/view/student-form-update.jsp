...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/stylesheet/addStudentForm.css" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid addStudentOuter" >
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
                <p align="center">
                    <img class="img-responsive studentAddImg"  width="70%" src="${pageContext.request.contextPath}/resources/images/userEdit.png">
                </p>
            </div>
            <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
            <%String url =(String)request.getAttribute("command"); %>
                <form:form method="POST" cssClass="form studentFormInput" action="<%=url %>" modelAttribute="student">
                    <form:hidden path="id"/>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('rollNo').setAttribute("readonly", "readonly");
