<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
	...
	<body>
				...
				<div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
					<p align="center">
						<img class="img-responsive" width="60%" style="" src="${pageContext.request.contextPath}/resources/images/sign.png">
					</p>
				</div>
				<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
					...
					<p class="error" align="center">
						<% if(request.getAttribute("userError")!=null){out.println(request.getAttribute("userError"));}%>
					</p>
					<form:form method="post" cssClass="form signUpForm" action="addStudent" modelAttribute="login">
						<br>
						<span>
							...
							<span class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
									<span class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
											...
											<form:input path="dateOfBirth" cssClass="form-control" placeholder="enter date of birth" required="required"/>
											</span>
										</span>
							</span>
							<span class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
